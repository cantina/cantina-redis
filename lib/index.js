...
var utils = require('cantina-utils')
  , cantinaModel = require('cantina-model')
  ;
...
module.exports.createModel = function(BaseClass, options) {
  var Model = cantinaModel.createModel(BaseClass, options);

  // If options.client is passes, expose it as a static class property.
  if (options.client) {
